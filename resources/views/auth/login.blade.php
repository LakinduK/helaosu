        ...
        <div class="card mb-0 shadow-none">
            <div class="card-body">
                ...
                <div class="px-3">
                    ...
                    <p class="text-muted text-center">Sign in to continue to Hela Osu - හෙළ ඔසු.</p>
    ...
    <div class="col-lg-9 p-0 h-100vh d-flex justify-content-center">
        <div class="accountbg d-flex align-items-center">
            <div class="account-title text-center text-white">
                <h4 class="mt-3">Welcome To <span class="text-warning">Hela Osu - හෙළ ඔසු Recipes</span> </h4>
                <h1 class="">Live naturally</h1>
                <h1 class="">Live herbal</h1>
                <p class="font-14 mt-3">Science of yoga and ayurveda is subtler than the science of medicine,
                    because science of medicine is often victim of statistical manipulation</p>
