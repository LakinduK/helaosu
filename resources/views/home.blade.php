        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Hela Osu - හෙළ ඔසු</a></li>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress mt-2" style="height:3px;">
                        <div class="progress-bar progress-animated  bg-purple" role="progressbar" style="max-width: 100%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="progress mt-2" style="height:3px;">
                        <div class="progress-bar progress-animated  bg-pink" role="progressbar" style="max-width: 100%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="recipe_diactivate/{{$recipe->id}}"><span class="badge badge-md badge-success">Active</span></a>
                                        @else
                                        <a href="recipe_activate/{{$recipe->id}}"><span class="badge badge-md badge-danger">Deactivated</span></a>
                                        @endif
                                    </td>
                                    <td>
                                        ...
                                        <input type="hidden" modalname="{{$recipe->recipename}}" modelimage="{{$recipe->recipeimage}}" modelingredients="{{$recipe->recipeingredients}}" modeldescription="{{$recipe->recipedescription}}" modelcategoryname="{{$recipe->categoryname}}" id="recipes{{$recipe->id}}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                        <span class="badge badge-md badge-danger">Deactivated</span>
                                        @endif
                                    </td>
                                    <td>
                                        <button data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg" type="button" onclick="viewData({{$recipe->id}})" class="btn btn-outline-dark mr-1"> <i class="far fa-eye"></i></button>
