...
<head>
  ...
  <title> Hela Osu - හෙළ ඔසු Recipes - Online Ayurvedic Recipes Management Application</title>
  <!-- App favicon -->
      ...
      <div class="uk-position-relative" data-uk-grid>
        <div class="uk-width-1-2@m uk-flex uk-flex-middle">
          <div class="uk-padding-large uk-padding-remove-right">
            ...
            <p class="uk-text-secondary">There are no secrets in Ayurveda.It's something you can learn,
              The more you let ayurveda for your living, the easier living gets..
            </p>
            <a class="uk-text-secondary uk-text-600 uk-text-small hvr-forward" href="{{ route('register') }}">Sign up today<span class="uk-margin-small-left" data-uk-icon="arrow-right"></span></a>
          </div>
        </div>
